...
ALTER TABLE `mitra_bps` ADD `is_active` INT NOT NULL DEFAULT '1' AFTER `nilai_menjadi_mitra`;
ALTER TABLE `pegawai` ADD `is_active` INT NOT NULL DEFAULT '1' AFTER `nilai_menjadi_mitra`;
