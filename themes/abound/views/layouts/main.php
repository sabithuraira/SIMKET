...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Monitoring Kinerja BPS Prov Sumatera Selatan</title>
	...
	<?php  
      ...
      <!-- styles for style switcher -->  
        <link rel="stylesheet" type="text/css" href="<?php echo $baseUrl;?>/js/plugins/fullcalendar/fullcalendar/bootstrap-fullcalendar.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo $baseUrl;?>/js/plugins/fullcalendar/fullcalendar/fullcalendar.css" />
    ...
    //$cs->registerScriptFile($baseUrl.'/js/plugins/fullcalendar/jquery/jquery-1.9.1.min.js');
    $cs->registerScriptFile($baseUrl.'/js/plugins/fullcalendar/fullcalendar/fullcalendar.min.js');
  ?>
  </head>
...
<section class="main-body">
    <div class="container-fluid">
            <div class="alert alert-success">
              <strong> NEXT Version : Cetak surat peringatan, Peringkat per seksi Provinsi, Rekap laporan kegiatan rutin bulanan (contoh susenas, sakernas, laporan absensi, dll) </strong><br/> 
            </div>
