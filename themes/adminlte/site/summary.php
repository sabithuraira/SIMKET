...
<div class="row-fluid">
  <div class="span2 ">
    <div class="stat-block">
      <ul>
        <li class="stat-count"><span><?php echo UnitKerja::model()->countByAttributes(array('jenis'=>2)); ?></span>
            <span>Kabupaten/Kota</span></li>
      </ul>
    </div>
  </div>
  <div class="span2 ">
    <div class="stat-block">
      <ul>
        <li class="stat-count"><span><?php echo ReportMe::TotalKegiatan(date('Y')); ?></span><span>Kegiatan <?php echo date('Y') ?></span></li>
      </ul>
    </div>
  </div>
  <div class="span2 ">
