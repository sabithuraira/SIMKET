...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('m_output')); ?>:</b>
	<?php echo CHtml::encode($data->m_output); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('m_induk')); ?>:</b>
	<?php echo CHtml::encode($data->m_induk); ?>
	<br />
