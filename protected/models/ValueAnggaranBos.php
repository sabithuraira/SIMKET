...
/**
 * This is the model class for table "value_anggaran_bos".
 *
 * The followings are the available columns in table 'value_anggaran_bos':
 * @property integer $id
...
class ValueAnggaranBos extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('tanggal_realisasi', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, unit_kerja, kegiatan, jenis, tanggal_realisasi, jumlah, created_time, created_by, updated_time, updated_by, keterangan', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ValueAnggaranBos the static model class
	 */
