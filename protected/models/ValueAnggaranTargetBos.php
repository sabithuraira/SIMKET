...
/**
 * This is the model class for table "value_anggaran_target_bos".
 *
 * The followings are the available columns in table 'value_anggaran_target_bos':
 * @property integer $id
 ...
 */
class ValueAnggaranTargetBos extends CActiveRecord
{
	/**
	...
	{
		return 'value_anggaran_target_bos';
	}
	 ...
	 * @return ValueAnggaranTargetBos the static model class
	 */
